...
import {addMoneyToBudget, createMesssage, repairHouse, toFireStaff, toHireStaff} from "./03";
...
test("Greeting should be correct for city", () => {
  const message = createMesssage(city)
  expect(message).toBe('Hello New York.I want you be happy. All 1000000')
});
